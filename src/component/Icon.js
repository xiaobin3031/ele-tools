...
export default function Icon({iconType, size = 'sm', ...props}){
  ...
  switch(size){
    case 'md':
      _style.width = _style.width || `${_initSize * 1.5}px`;
      _style.height = _style.height || `${_initSize * 1.5}px`;
      break;
    case 'lg':
      _style.width = _style.width || `${_initSize * 2}px`;
      _style.height = _style.height || `${_initSize * 2}px`;
      break;
    default: 
      _style.width = _style.width || `${_initSize}px`;
      _style.height = _style.height || `${_initSize}px`;
      break;
  }
